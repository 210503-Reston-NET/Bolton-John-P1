...
namespace StoreDL
{
    ...
    {
        private WidgetStoreDBContext _context;
        ...
        public List<Customer> GetAllCustomers()
        {
            return _context.Customers.Select(customer =>
                new Customer(customer.CustomerID, customer.FirstName, customer.LastName, customer.PhoneNumber, customer.Email)
            ).ToList();
        }
        ...
        {
            Customer found = _context.Customers.FirstOrDefault(custo => custo.FirstName == customer.FirstName && custo.LastName == customer.LastName && custo.PhoneNumber == customer.PhoneNumber && custo.Email == customer.Email);
            if (found == null)
            {
                return null;
            }
